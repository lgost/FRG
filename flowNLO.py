...
##########################################################################
	...
	def spline(self, f:my_dataclasses.F_NLO):
		...
		# TODO experiment what is faster a) here with self.p without passing arguments b) passing all these arguments, c) passing only p,Nw,p+q and calculationg p+q/pmax
