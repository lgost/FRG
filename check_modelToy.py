...
model_params = n_f, approximation, dim, version_Ak
...
""" 06/07/2026 No 2
Returned name "update": f_spline_upd, f_spline_upd_NLO/LO (because it happens inside Evolution)
Moved grids, r, coeff_nu to Evolution (numbers)
Implemented and checked splines. Added self.f_spl, self.f_spl_w, self.fq (f on q) to Evo.
"""
